...
// 1. I TUOI DATI (Il "Database" del Portfolio)
const PROJECTS = [
  {
    id: 1,
    title: "Travel Easy",
    category: "App Design",
    slug: "travel-easy",
    image: "/images/travel-easy.webp", // <-- Sostituisci con i veri nomi delle tue immagini
    colSpan: 1,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    colSpan: 2, // <-- LA MAGIA: Questo progetto occuperà due colonne su desktop!
  },
  {
    id: 4,
    title: "Frame",
...
// 2. EFFETTO TESTO LIQUIDO (Stesso stile della pagina About)
...
export default function PortfolioPage() {
  ...
  const { scrollYProgress } = useScroll({
    target: textRef,
    offset: ["start 90%", "start 30%"], // Il testo si illumina mentre scendi
  });
  ...
  return (
    <div className="min-h-screen bg-black text-white w-full flex flex-col pt-[120px] lg:pt-[160px] pb-24">
      <main className="flex-1 w-full max-w-[1600px] mx-auto px-4 min-[700px]:px-8">
        ...
        {/* SECTION 1: Titolo Introduttivo Animato */}
        ...
        {/* SECTION 2: La Griglia Bento */}
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {PROJECTS.map((project) => (
            <Link
              key={project.id}
              href={`/portfolio/${project.slug}`}
              // Se colSpan è 2, la card si allarga su entrambe le colonne su schermi medi/grandi
            ...
            >
              {/* Contenitore Immagine con proporzioni perfette */}
              <div
              ...
              {/* Riga di Testo sotto l'immagine */}
